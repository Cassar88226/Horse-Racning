...
while d < end_date:
    ...
    d += inc
                ...
                # just some logging to show that its all working
                
            
                # do what you want with this data - store it, print it, etc
                # meeting, market and event are all in scope here. You can use a value from any of them
                # print(meeting, market, event)
            
        # increment to the next day before we repeat the date loop
         


# setup logging
#logging.basicConfig(level=logging.INFO)  # change to DEBUG to see log all updates
#certs_path = r'C:\Users\Brad\client-2048'
#my_username = 'botman01'
#my_password = 'botbetting1'
#my_app_key = 'a3v624ittFlWQRoK'


#openssl x509 -x509toreq -in certificate.crt -out CSR.csr -signkey privateKey.key
 
 
#mycert = (r'C:\Users\Brad\DocumentsBFAPI.crt', r'C:\Users\Brad\BFAPI.pem') 
...
#trading = betfairlightweight.APIClient(username = 'botman01', password = 'botbetting1', app_key = 'a3v624ittFlWQRoK', certs = mycert)
